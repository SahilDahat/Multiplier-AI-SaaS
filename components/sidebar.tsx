...
import { usePathname } from "next/navigation"; //usage?
...
const routes = [{ label: 'Dashboard', icon: LayoutDashboard, href: '/dashboard', color: "text-green-200"},
  ...
  { label: 'Settings', icon: Settings, href: '/settings', color: "text-sky-500"},
];
    ...
    <div className="space-y-4 py-4 flex flex-col h-full bg-[#111827] text-white">
      <div className="px-3 py-2 flex-1">
        ...
        <Link href="/dashboard" className="flex items-center pl-3 mb-14">
          <div className="relative h-8 w-8 mr-4"> <Image fill sizes="10vw" alt="Logo" src="/logo.png" /> </div>
          <h1 className={cn("text-2xl font-bold", poppins.className)}> MultiplierAI </h1>
        </Link>
